...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--height",
                                 ...
                                 default=320) # previous is 192
        self.parser.add_argument("--width",
                                 type=int,
                                 help="input image width",
                                 default=1024) # previous is 640
        ...
        self.parser.add_argument("--use_ssim_compare_mask",
                                 action="store_true")
        self.parser.add_argument("--is_stable_mask",
                                 action="store_true")
        self.parser.add_argument("--depth_hint_param",
                                 type=float,
                                 default=1)
        self.parser.add_argument("--is_texture_weighted",
                                 action="store_true")
        ...
        # DATASET options
        self.parser.add_argument("--load_semantics",
                                 action="store_true")
        self.parser.add_argument("--seman_path",
                                 type=str,
                                 default="Nothing"
                                 )
        ...
        self.parser.add_argument("--load_unbnPred",
                                 action="store_true")
        ...
        self.parser.add_argument("--post_process",
                                 ...
                                 action="store_true")
        self.parser.add_argument("--UseGtMedianScaling",
                                 action="store_true"
                                 )
